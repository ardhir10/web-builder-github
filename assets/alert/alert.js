...
!function($){
	...
	$.confirm=function(){
		...
		if(args.length){
			...
			d = $('<div class="alert_overlay '+($._ismob?'mob':'pc')+'"><div class="alert_msg"><div class="alert_content">'+args[0]+'</div><div class="alert_buttons"><button class="alert_btn alert_btn_cancel">Batal</button><button class="alert_btn alert_btn_ok">Ok</button></div></div></div>')
			.on('contextmenu',!1)
