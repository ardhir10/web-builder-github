    ...
    pluginsOpts: {
        'gjs-plugin-export': {
            ...
            preHtml: `<!doctype html>
                        ...
                        <body>`,
            postHtml: `<!-- this page is generateded by Gramateria Ramass -->
                        </body>
                        </html>`
        }
    },
...
//                }, 
    ...
    //     },
    //     assets: [
    //             $.getJSON( 'http://localhost/ci_app/web-builder-github/Apigambar/read_image', function( data ) {
    //               console.log( data );
    //                $.each(data, function(index) {
    //                     // alert(data[index].gambar);
    //                     {
    //                         type: 'image',
    //                         src: 'http://localhost/ci_app/web-builder-github/image-server/website'+data[index].gambar,
    //                         date: '2015-02-01',
    //                         height: 808,
    //                         width: 1440
    //                     },
    ...
    assetManager: {
            ...
            uploadName: 'file',
            upload: 'http://localhost/ci_app/web-builder-github/image-server/website/', //for temporary storage
            assets      : [ ],
...
pnm.addButton('options', [{
    ...
    },
    {
        ...
        command: function (editor, sender) {
            sender.set('active', 0);
            // alert('No databaseSSS for this version but your work is automatically saved in localstorage.');
            saveContent();
        },
        attributes: {
            title: 'github'
