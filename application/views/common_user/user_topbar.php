     ...
     <!--  <li class="nav-item language">
      ...
      <li class="nav-item">
        <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="#">
          <span class="user-profile"><img src="<?php echo base_url() ?>assets/images/avatars/<?php echo $this->session->userdata('adminGambar'); ?>" class="img-circle" alt="user avatar"></span>
        </a>
        <ul class="dropdown-menu dropdown-menu-right">
