      ...
      <i class="fa fa-bell-o"></i><span class="badge badge-info badge-up">14</span></a>
        ...
        <ul class="dropdown-menu dropdown-menu-right">
            ...
            <li class="nav-item">
                ...
                <?php }else{ ?>
                <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="#">
                    <span class="user-profile"><img src="<?php echo $this->session->userdata('userGambar'); ?>" class="img-circle" alt="user avatar"></span>
                </a>
                    ...
                    <li class="dropdown-item user-details">
                        <a href="javaScript:void();">
                            <div class="media">
                                ...
                                <div class="avatar"><img class="align-self-start mr-3" src="<?php echo $this->session->userdata('userGambar'); ?>" alt="user avatar"></div>

                                <?php } ?>
                                <div class="media-body">
                                    <h6 class="mt-2 user-title">
                                        <?php echo $this->session->userdata('userNama'); ?>
                                    </h6>
