    ...
    <div class="container-fluid">
      ...
      <!-- End Breadcrumb-->
         <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header"><i class="fa fa-table"></i> Data Admin
                <br>
              ...
              <div class="card-body">
                <form action="<?php echo base_url().$controller ?>/update/<?php echo $data_admin->ID; ?>" method="post">
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label>Email Admin :</label>
                        <input class="form-control" type="text" name="email_admin" value="<?php echo $data_admin->email ?>">
                      </div>
                    </div>
                  </div>
